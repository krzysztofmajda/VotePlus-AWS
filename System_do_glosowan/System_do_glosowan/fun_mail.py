...
def welcome_message(email,name,username,surname,sex,birth_year, code):
    ...
    line4 = "Imię i nazwisko: " + name + " " + surname + "<br> Płeć: " + sex + "<br> Rok urodzenia: " + birth_year + "<br><br>"
...
def password_reset(email,username,code):
    ...
    line2 = "Jeżeli nie wysyłałeś prośby o zresetowanie hasła, to zignoruj tego maila."
...
def edit_user(name, surname, role, sex, birth_year, username, email):
    ...
    line3 = "Imię i nazwisko: " + name + " " + surname + "<br> Płeć: " + sex + "<br> Rok urodzenia: " + birth_year + "<br>"
    line4 = "Uprawnienia do tworzenia i zarządania głosowaniami: " + role
...
def delete_user(name, surname, sex, birth_year, username, email):
    ...
    line2 = "Imię i nazwisko: " + name + " " + surname + "<br> Płeć: " + sex + "<br> Rok urodzenia: " + str(birth_year) + "<br><br>"
    line3 = "Dziękujemy, że skorzystałeś z usług naszego systemu."
...
def delete_serially_user(username, email):
    ...
    line2 = "Ani razu nie zalogowałes się na swoje konto i nie potwiedziłes rejestracji, dlatego Twoje konto zostało usunięte z naszej bazy. <br>"
